...
## Create custom ffva audiopipeline
add_library(sln_voice_app_ffva_audio_pipeline_adec_aec_2x_2y_no_comms INTERFACE)
target_sources(sln_voice_app_ffva_audio_pipeline_adec_aec_2x_2y_no_comms
    INTERFACE
...
target_include_directories(sln_voice_app_ffva_audio_pipeline_adec_aec_2x_2y_no_comms
    INTERFACE
        ${CMAKE_CURRENT_LIST_DIR}/api
...
target_link_libraries(sln_voice_app_ffva_audio_pipeline_adec_aec_2x_2y_no_comms
    INTERFACE
        core::general
        rtos::freertos
        rtos::sw_services::generic_pipeline
...
## Create an alias
add_library(sln_voice::app::ffva::ap::adec ALIAS sln_voice_app_ffva_audio_pipeline_adec_aec_2x_2y_no_comms)

## Create custom ffva audiopipeline
add_library(sln_voice_app_ffva_audio_pipeline_adec_aec_2x_2y_no_comms_altarch INTERFACE)
target_sources(sln_voice_app_ffva_audio_pipeline_adec_aec_2x_2y_no_comms_altarch
    INTERFACE
...
target_include_directories(sln_voice_app_ffva_audio_pipeline_adec_aec_2x_2y_no_comms_altarch
    INTERFACE
        ${CMAKE_CURRENT_LIST_DIR}/api
...
target_link_libraries(sln_voice_app_ffva_audio_pipeline_adec_aec_2x_2y_no_comms_altarch
    INTERFACE
        core::general
        rtos::freertos
        rtos::sw_services::generic_pipeline
