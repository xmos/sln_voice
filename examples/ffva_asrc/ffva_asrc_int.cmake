...
set(FFVA_INT_COMPILE_DEFINITIONS
    ...
    appconfI2S_AUDIO_SAMPLE_RATE=176400
...
foreach(FFVA_AP ${FFVA_PIPELINES_INT})
    ...
    # Tile Targets
    #**********************
    set(TARGET_NAME tile0_example_ffva_asrc_int_${FFVA_AP})
    ...
    target_link_libraries(${TARGET_NAME}
        PUBLIC
            ...
            sln_voice::app::ffva_asrc::xk_voice_l71
            sln_voice::app::ffva::ap::${FFVA_AP}
    )
    target_link_options(${TARGET_NAME} PRIVATE ${APP_LINK_OPTIONS})
    unset(TARGET_NAME)

    set(TARGET_NAME tile1_example_ffva_asrc_int_${FFVA_AP})
    add_executable(${TARGET_NAME} EXCLUDE_FROM_ALL)
    target_sources(${TARGET_NAME} PUBLIC ${APP_SOURCES})
    target_include_directories(${TARGET_NAME} PUBLIC ${APP_INCLUDES})
    target_compile_definitions(${TARGET_NAME}
    ...
    # Merge binaries
    #**********************
    merge_binaries(example_ffva_asrc_int_${FFVA_AP} tile0_example_ffva_asrc_int_${FFVA_AP} tile1_example_ffva_asrc_int_${FFVA_AP} 1)

    #**********************
    # Create run and debug targets
    #**********************
    create_run_target(example_ffva_asrc_int_${FFVA_AP})
    create_debug_target(example_ffva_asrc_int_${FFVA_AP})

    #**********************
    # Create data partition support targets
    #**********************
    set(TARGET_NAME example_ffva_asrc_int_${FFVA_AP})
