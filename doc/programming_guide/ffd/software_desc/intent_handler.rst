...
This function has the role of creating the keyword handling task for the ASR engine. In the case of the Sensory and Cyberon model, the application provides a FreeRTOS Queue object. This handler is on the same tile as the speech recognition engine, tile 0.
