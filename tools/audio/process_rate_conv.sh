...
# call sox pipelines
SOX_PLAY_OPTS="--buffer=65536 --bits=16 --encoding=signed-integer --endian=little --no-dither"
SOX_REC_OPTS="--buffer=65536 --channels=6 --bits=16 --encoding=signed-integer --endian=little --no-dither"
