...
set(APP_INCLUDES
    ...
    ${CMAKE_CURRENT_LIST_DIR}/../ffva/src/dfu_int
...
# Tile Targets
#**********************
set(TARGET_NAME tile0_example_ffd_i2s_cyberon)
...
set(TARGET_NAME tile1_example_ffd_i2s_cyberon)
add_executable(${TARGET_NAME} EXCLUDE_FROM_ALL)
target_sources(${TARGET_NAME} PUBLIC ${APP_SOURCES})
target_include_directories(${TARGET_NAME} PUBLIC ${APP_INCLUDES} ${RTOS_CONF_INCLUDES})
...
# Merge binaries
#**********************
merge_binaries(example_ffd_i2s_cyberon tile0_example_ffd_i2s_cyberon tile1_example_ffd_i2s_cyberon 1)

#**********************
# Create run and debug targets
#**********************
create_run_target(example_ffd_i2s_cyberon)
create_debug_target(example_ffd_i2s_cyberon)

#**********************
# Create data partition support targets
#**********************
set(TARGET_NAME example_ffd_i2s_cyberon)
