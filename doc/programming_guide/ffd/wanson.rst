...
The Wanson speech recognition library is `Copyright 2022. Shanghai Wanson Electronic Technology Co.Ltd ("WANSON")` and is subject to the `Wanson Restrictive License <https://github.com/xmos/sln_voice/blob/develop/modules/asr/wanson/lib/LICENSE.md>`__.
...
More information on these options can be found in the FFD :ref:`sln_voice_ffd_configuration` section.
