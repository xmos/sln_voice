...
add_library(sln_voice_app_stlp_board_support_xcore_ai_explorer INTERFACE)
target_sources(sln_voice_app_stlp_board_support_xcore_ai_explorer
    INTERFACE
...
target_include_directories(sln_voice_app_stlp_board_support_xcore_ai_explorer
    INTERFACE
        ${CMAKE_CURRENT_LIST_DIR}
)
target_link_libraries(sln_voice_app_stlp_board_support_xcore_ai_explorer
    INTERFACE
        core::general
        rtos::freertos
        ...
        rtos::drivers::audio
        rtos::drivers::usb
        sln_voice::app::stlp::dac::aic3204
)
target_compile_options(sln_voice_app_stlp_board_support_xcore_ai_explorer
    INTERFACE
        ${CMAKE_CURRENT_LIST_DIR}/XCORE-AI-EXPLORER.xn
)
target_link_options(sln_voice_app_stlp_board_support_xcore_ai_explorer
    INTERFACE
        ${CMAKE_CURRENT_LIST_DIR}/XCORE-AI-EXPLORER.xn
)
target_compile_definitions(sln_voice_app_stlp_board_support_xcore_ai_explorer
    INTERFACE
        XCOREAI_EXPLORER=1
...
## Create an alias
add_library(sln_voice::app::stlp::xcore_ai_explorer ALIAS sln_voice_app_stlp_board_support_xcore_ai_explorer)
