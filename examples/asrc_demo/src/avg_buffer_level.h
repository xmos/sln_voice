...
typedef struct
{
    ...
    int32_t prev_avg_buffer_level; /// Average buffer level for the previous window
    ...
    bool flag_prev_avg_valid;   /// Flag indicating if the average value is stable
    bool flag_first_done;   /// Flag indicating if the very first average has been computed
